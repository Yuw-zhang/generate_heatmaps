...
#        print(np.genfromtxt(file_path, delimiter=' ', skip_header=1 if self.skip_header else 0))
    ...
    def extract(self, indexes):
        ...
        xys_pred = ((filteredData[:, [0, 1]] + self.patchSize / 2) / self.patchSize - 1).astype(np.int32)
